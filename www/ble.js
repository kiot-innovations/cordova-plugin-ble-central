    ...
    module.exports.mesh = {
        ...
        sendOnOffCommand: function sendOnOffCommand(unicastAddress, appKeyIndex, OnOff, success, failure) {
            cordova.exec(success, failure, pluginName, 'mesh_sendOnOffCommand', [unicastAddress, appKeyIndex, OnOff]);
        },
        sendLightnessCommand: function sendLightnessCommand(unicastAddress, appKeyIndex, lightness, success, failure) {
            cordova.exec(success, failure, pluginName, 'mesh_sendLightnessCommand', [unicastAddress, appKeyIndex, lightness]);
        },

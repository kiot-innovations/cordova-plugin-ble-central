...
public enum ConfigState implements Serializable {
   ...
   * default: 00000000
   */
  KEY_REFRESH_PHASE("Key Refresh Phase",
   ...
   */
  ON_DEMAND_PRIVATE_GATT_PROXY("On-Demand Private GATT Proxy",
   ...
   * Proxy Solicitation
   */
  // PROXY_SOLICITATION("Proxy Solicitation", "A Proxy Client may use the GAP
  // General Discoverable mode with non-connectable non-scannable undirected
  // advertising events to send Solicitation PDUs to solicit a Proxy Server that
  // supports the Private Proxy functionality to start advertising with Private
  // Network Identity type"),

  // in RELAY
  // RELAY_RETRANSMIT("Relay Retransmit", "The Relay Retransmit state is a
  // composite state that controls parameters of retransmission of the Network PDU
  // relayed by the node."),
  ;

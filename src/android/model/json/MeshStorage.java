...
public class MeshStorage {
  ...
  public static class PublishPeriod {
    /**
     * The numberOfStepa property contains an integer from 0 to 63 that represents
   ...
   * all provisioners will be saved in provisioner list
   * {@link MeshInfo#allProvisioners},
  ...
  public MeshInfo convertToMeshInfo() {
    ...
    for (ApplicationKey applicationKey : appKeys) {
      meshInfo.appKeyList.add(new MeshAppKey(applicationKey.name, applicationKey.index,
